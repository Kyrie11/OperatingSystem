...
public class Snake {
    ...
    private static final int INCREASE_SPEED = 15; //每吃一个食物增加的速度
    private volatile String operation;//用户的操作
    ...
    public void move() {
        MoveThread moveThread = new MoveThread();//创建一个线程
    ...
    //向上移动
    public void moveUp() {
        if((getX(0)-1 +","+ getY(0)).equals(snakeBody.get(1))) {//判断蛇头的方向是否是朝着自己身体的方向
            return;
        }
    ...
    public void initSnake() {
        snakeBody = new LinkedList<String>();
